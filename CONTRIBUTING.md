# Contributing to ossnotices

First off, thank you for considering contributing to ossnotices! It's people like you that make ossnotices such a great tool.
...
```bash
# Clone your fork
git clone https://github.com/your-username/ossnotices.git
cd ossnotices
...
```bash
# 1. Bump the version in pyproject.toml and ossnotices/__init__.py, add a CHANGELOG entry, merge it
...
Confirm the upload with the version-specific endpoint, `https://pypi.org/pypi/ossnotices/X.Y.Z/json`.
The aggregate `https://pypi.org/pypi/ossnotices/json` is cached and can lag a few minutes behind,
which looks like a failed upload when it is not.

## Community

You can chat with the community on:
- [GitHub Discussions](https://github.com/SemClone/ossnotices/discussions)
- [Issues](https://github.com/SemClone/ossnotices/issues)
